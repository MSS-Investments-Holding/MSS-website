  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="inline-flex items-center gap-2 mb-6 px-3"
          style={{
            height: "24px",
            backgroundColor: "rgba(255,255,255,0.10)",
          }}
        >
          {/* Exact arrow SVG from Figma node 242:4821 */}
          ...
          <span className="font-body text-white" style={{ fontSize: "12px", lineHeight: "16px" }}>
