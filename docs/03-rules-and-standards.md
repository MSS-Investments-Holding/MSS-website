...
| Tablet | 768px | `md:` |
| Desktop | 1440px | `lg:` |
| Wide | 1920px | `xl:` (use sparingly — cap max content width at 1280–1440px) |

- **Max content width:** `max-w-screen-xl` (1280px) or `max-w-[1440px]` — centred with `mx-auto px-6` (mobile) `px-12` (md) `px-20` (lg)
