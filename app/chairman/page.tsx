...
const letterParagraphs = [
  ...
  "MSS Investments Holding was built with a clear belief: the next generation of economic growth will be shaped by the systems, platforms, and technologies that enable people and businesses to move, transact, build, and scale with greater efficiency.",
  "Across the world, markets are changing rapidly. Finance is becoming more connected, technology is becoming more embedded in everyday operations, and businesses are being asked to move with both speed and responsibility.",
  "In this environment, we believe the role of a holding company must go beyond ownership. Capital alone is no longer enough. The strongest businesses need strategic direction, operational discipline, trusted relationships, and the patience to build for long-term relevance.",
  "At MSS, our focus is to bring these elements together across a portfolio of businesses connected by a shared view of the future. Our work spans payments, financial services, artificial intelligence, digital infrastructure, and venture-backed platforms. These are not separate areas of interest for us. They are part of a broader shift in how modern economies are being built. The movement of money, the intelligence behind systems, the infrastructure supporting digital services, and the ability to scale strong ideas into sustainable businesses are all becoming increasingly connected. This is where MSS aims to play a meaningful role.",
  "We seek opportunities where technology serves a real market need, where execution is as important as ambition, and where long-term value can be built with discipline. Our responsibility is to identify businesses with potential, support them with clarity, and help create the conditions for sustainable growth.",
  "As Chairman, I believe deeply in the importance of governance, trust, and focus. Growth without structure can become fragile. Innovation without responsibility can lose direction. Ambition without discipline can fall short of its promise. Our approach is therefore grounded in selectivity, strategic alignment, and a commitment to building businesses that can endure.",
  "We are also conscious of the regions in which we operate. MSS is positioned across markets that are becoming increasingly important to the future of finance, technology, and trade. From the Middle East and South Asia to the United Kingdom and broader international corridors, our footprint reflects a deliberate view of where opportunity is developing and where strong businesses can create lasting impact.",
  "To our investors and partners, we value the trust placed in us. Trust is not built through statements alone; it is built through consistency, transparency, performance, and responsible decision-making. We understand the responsibility that comes with managing relationships, capital, and opportunity, and we remain committed to doing so with care.",
  "To the founders, operators, and teams within our ecosystem, your work is central to the future we are building. Ideas become meaningful only when they are executed with discipline. Businesses grow when people bring conviction, skill, and resilience to the work every day. MSS exists to support that effort and to help strong teams move with greater clarity and confidence.",
  "Looking ahead, our priorities remain focused. We will continue to strengthen our portfolio, deepen our presence across relevant markets, and pursue opportunities aligned with the structural shifts shaping modern economies. We will remain open to innovation, but disciplined in how we approach it. We will continue to build, but with purpose. And we will continue to invest, but with a long-term view.",
  "The future will belong to organisations that can combine capital with capability, technology with trust, and ambition with structure. This is the standard we are working toward at MSS Investments Holding.",
  "On behalf of the leadership team, I thank our partners, investors, colleagues, and stakeholders for their continued trust and support. We look forward to building what comes next, together.",
];
