    ...
    <main id="main-content">
      ...
      >
        ...
        <div className="absolute inset-0 z-10">
          <div
            className="chairman-hero-label inline-flex items-center"
      ...
      <section
        ...
        className="w-full bg-white px-5 md:px-12 lg:px-20 pt-16 md:pt-20 pb-4"
      >
        <div className="flex flex-col lg:flex-row lg:gap-[10%] xl:gap-[178px]">
           ...
           */}
          <div className="flex-shrink-0 lg:w-[340px] mb-20 lg:mb-0">

            {/* Portrait — reuse the homepage leader frame (navy bg baked in, node 242:5007) */}
            <div className="chairman-portrait-frame relative overflow-hidden bg-[#0B1738]">
              <Image
